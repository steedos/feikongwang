...
module.exports = {
    ...
    handler: async function (ctx) {
        ...
        // 判断spaces_user里是否有该用户
        // const spaceUsersDoc = await ctx.broker.call(
        //     'objectql.findOne',
        //     {
        //         objectName: 'space_users',
        //         query: {
        //             filters: [['qywx_id', '=', userDetailData.userid]]
        //         }
        //     }
        // );
         ...
         */
         // 创建space_user
         const data = await ctx.broker.call('@steedos/plugin-qywx.createSpaces_users', {
            "user": userDetailData,
